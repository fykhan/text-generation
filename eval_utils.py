"""
Evaluation utilities for text generation and reasoning tasks.

Provides scoring functions for multiple-choice and free-form question datasets,
including numeric answer extraction and fuzzy string matching.
"""
